...
<p align="center">
  <iframe width="800" height="520" src="images/voteswitchR-package.html" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</p>
...
- Determine if a "canned solution" already exists.
    ...
    - It exists but falls short of accomplishing what you want to do? $\rightarrow$ Build up on it!
    - It doesn't exist? $\rightarrow$ It may seem like you are starting from scratch, but most likely, many parts of your model will resemble existing (Stan) models.
- Choose the correct likelihood for your model. Stan will almost certainly feature the required log probability function.
...
- After validation and inference, get the most out of your posterior samples. Process your posterior draws into substantively meaningful quantities of interest, and visualize whenever possible.
