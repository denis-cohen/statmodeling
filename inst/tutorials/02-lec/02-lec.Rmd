...
One problem with the sensitivity of first differences and marginal effects to the choice of $\mathbf{x}$ is that makes these quantities of interest dependent on subjective judgment.
