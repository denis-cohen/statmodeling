...
\eta_{ij} & = \gamma_{11} + \gamma_{21} \mathtt{bl\_immig}_j + \nu_{j1} + \gamma_{12} x_i + \gamma_{22} \mathtt{bl\_immig}_j x_i + \nu_{j2} x_i  + \epsilon_i \\
\eta_{ij} & = \gamma_{11} + \underbrace{\gamma_{12} x_i + \gamma_{21} \mathtt{bl\_immig}_j + \gamma_{22} \mathtt{bl\_immig}_j x_i}_{\text{interaction}} + \underbrace{\epsilon_i + \nu_{j1} + \nu_{j2} x_i}_{\text{composite errors}}
\end{split}$$
