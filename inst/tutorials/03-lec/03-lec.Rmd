...
- An assignment of a parametric form for the outcome variable $y$.
- Also called the data generating process (or the generative model) for $y$.
- Involves the specification of a pdf or pmf: $p(\mathbf{y}|\theta)$.
...
- Let's pretend our prior belief is completely naive: 
    ...
    - Our prior belief for $\sigma = \frac{1}{\tau}$ will also be vague: $\tau \sim \Gamma(\alpha = 20, \beta = 200)$
...
```{r prior-sim, exercise=TRUE, exercise.lines = 30, fig.align='center', fig.width = 9, fig.height=5}
# Apply function
draws_prior <-
  draw_from_prior(
    theta = 0,
