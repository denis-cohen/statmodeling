...
We now want to use our posterior draws to generate more complex substantively meaningful quantities of interest: A Bayesian version of the 3D visualization from Lab 1.
...
```{r compilation, exercise=TRUE, exercise.timelimit = 120}
lm_mod <- ...
...
```{r viz, exercise=TRUE, fig.align='center', fig.width = 9, fig.height=6, exercise.timelimit = 120}
