...
```{r prior-sim, echo = TRUE, fig.align='center', fig.width = 9, fig.height=5}
# Apply function
draws_prior <-
  draw_from_prior(
    theta = 0,
...
```{r posterior-sim, eval=TRUE, fig.align='center', fig.width = 9, fig.height=9}
# Apply function
draws_posterior <-
  draw_from_posterior(
    theta = 0,
...
```{r joint-posterior, eval = TRUE, fig.align='center', fig.width = 6, fig.height=6, fig.align='center'}
# Apply function
draws_posterior <-
  draw_from_posterior(
    theta = 0,
