...
In the second half of the workshop, we will use [`Stan`](https://mc-stan.org/) via
...
The workshop consists of five sessions à 180 minutes. Each
...
Those who prefer working on the lab exercises outside of the interactive `learnr` environment (i.e., in a regular R session) can use the `Rmd` files supplied in the folder `lab-materials`, which contains both exercises and solutions.

## About the Instructor

Denis Cohen is a postdoctoral fellow in the Data and Methods Unit at the [Mannheim Centre for European Social Research
